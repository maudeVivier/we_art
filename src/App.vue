<template>
  <v-app>
    <router-view @update-notifications="fetchEventsCountNotifs" />
    <v-bottom-navigation
      app
      v-model="active"
    ...
    >
      ...
      >
        <div class="content-container">
          <div v-if="numberNotif > 0" class="top-row">
            <v-badge
              :content="numberNotif"
              color="red"
              overlap
            ...
            >
              ...
              >
                <path 
                  fill-rule="evenodd" 
                  clip-rule="evenodd" 
                  d="M13.5996 8.17091C13.1856 8.17091 12.8496 7.83491 12.8496 7.42091V4.99991C12.8496 4.58591 13.1856 4.24991 13.5996 4.24991C14.0136 4.24991 14.3496 4.58591 14.3496 4.99991V7.42091C14.3496 7.83491 14.0136 8.17091 13.5996 8.17091Z" 
                  :fill="active === 1 ? '#F2992C' : 'black'"
                />
                <path 
                  fill-rule="evenodd" 
                  clip-rule="evenodd" 
                ...
                <path 
                  fill-rule="evenodd" 
                  clip-rule="evenodd" 
                  d="M13.5996 15.8252C13.1856 15.8252 12.8496 15.4892 12.8496 15.0752V10.2542C12.8496 9.84021 13.1856 9.50421 13.5996 9.50421C14.0136 9.50421 14.3496 9.84021 14.3496 10.2542V15.0752C14.3496 15.4892 14.0136 15.8252 13.5996 15.8252Z" 
                  :fill="active === 1 ? '#F2992C' : 'black'"
                />
                <mask 
                  id="mask0_4_3751" 
      ...
      >
      <div class="content-container">
        <div v-if="numberNotifConv > 0" class="top-row">
          <v-badge
...
export default {
  ...
  watch: {
    // Vous pouvez aussi utiliser un watcher si nécessaire pour surveiller l'état de l'événement
    $route() {
      if (this.userConnected) {
