...
const { getUsers, createUser, updateUser, deleteUser, loginUser, verifyEmail, getUserEvents, getUserById, checkEmail, resendCode, getUserNotifsEvents, getUserNotifsCount} = require('../controllers/usersController');
